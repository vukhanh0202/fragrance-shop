            ...
            <div class="title-bar">
                ...
                <div class="title-bar-action">
                    <div class="align-center">
                        <a href="<c:url value="/quan-tri/blog/chinh-sua-blog"/>"
                           class="d-none d-sm-inline-block btn btn-sm btn-primary shadow-sm">Thêm blog</a>
                    </div>
                    <div class="align-center">
                ...
                <ul class="nav nav-tabs" id="myTab" role="tablist">
                    <li class="nav-item">
                        <a class="nav-link active" id="all-tab" data-toggle="tab" href="#all"
                           role="tab" aria-controls="all" aria-selected="true">Tất cả blog</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" id="male-tab" data-toggle="tab" href="#male"
                           role="tab" aria-controls="male" aria-selected="false">Kiến thức nước hoa</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" id="female-tab" data-toggle="tab" href="#female"
                           role="tab" aria-controls="female" aria-selected="false">Review nước hoa</a>
                    </li>
                </ul>
                <!--End Nav Button  -->
                        ...
                        <div class="table-responsive">
                            <table class="table table-bordered">
                                ...
                                <tr>
                                    ...
                                    <th style="width:100px;">Ảnh thu gọn</th>
                                    <th>Tiêu đề</th>
                                    <th>Mô tả ngắn</th>
                                    <th>Loại bài viết</th>
                                    <th>Ngày tạo</th>
                                ...
                                <c:forEach var="item" items="${model.listResult}">
                                    <tr>
                                        ...
                                        <td><img alt="" src="<c:out value="${item.thumbnail}"/>"
                                                 style="float: left; height: 100px; width: 100px;"></td>
                                        <td>${item.title}</td>
                                        <td>${item.shortDescription}</td>
                                        <td>${item.typeBlog}</td>
                                        <td>${item.createdDate}</td>
                                        <td>
                                            <c:url var="detail" value="/quan-tri/blog/chinh-sua-blog">
                    ...
                    <div class="tab-pane fade" id="male" role="tabpanel"
                        ...
                        <div class="table-responsive">
                            <table class="table table-bordered">
                                ...
                                <tbody>
                                <c:forEach var="item" items="${modelKnowledge.listResult}">
                                    <tr>
                                        <td><input type="checkbox" id="checkbox_${item.id}" value="${item.id}"></td>
                                        <td><img alt="" src="<c:out value="${item.thumbnail}"/>"
                                                 style="float: left; height: 100px; width: 100px;"></td>
        ...
        function deleteBill(data) {
            $.ajax({
                ...
                success: function (result) {
                    window.location.href = "${listBlog}?page=1&limit=10&message=delete_success";
                },
