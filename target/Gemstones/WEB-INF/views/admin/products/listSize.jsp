...
<head>
    ...
    <title>Danh sách size sản phẩm</title>
</head>
<body>
            ...
            <div class="title-bar">
                ...
                <div class="title-bar-action">
                    <div class="align-center">
                        <a href="<c:url value="/quan-tri/san-pham/chinh-sua-size"/>" class="d-none d-sm-inline-block btn btn-sm btn-primary shadow-sm">Thêm size
                            </a>
                    </div>
                    <div class="align-center">
                ...
                <nav style="margin-bottom:15px;">
                    <div class="nav nav-tabs" id="nav-tab" role="tablist">
                        <a class="nav-item nav-link active" id="nav-all-tab" data-toggle="tab" href="#nav-all"
                           role="tab" aria-controls="nav-all" aria-selected="true">Tất cả size</a>
                    </div>
                </nav>
                <!--End Nav Button  -->
                    ...
                    <table class="table table-bordered">
                        ...
                        <c:forEach var="item" items="${model.listResult}">
                            <tr>
                                ...
                                <td>
                                    <c:url var="updateSize" value="/quan-tri/san-pham/chinh-sua-size">
                                        <c:param name="id" value="${item.id}"/>
                                    </c:url>
                                    <a class="btn btn-sm btn-primary btn-edit" data-toggle="tooltip"
                                       title="Cập nhật" href='${updateSize}'><i class="fas fa-edit"></i>
                                    </a>
                                </td>
                            </tr>
                        </c:forEach>
        ...
        function deleteSize(data) {
            $.ajax({
                ...
                success: function (result) {
                    window.location.href = "${listProductSize}?page=1&limit=10&message=delete_success";
                },
