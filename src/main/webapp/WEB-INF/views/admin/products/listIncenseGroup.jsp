...
<head>
    ...
    <title>Danh sách nhóm hương</title>
</head>
<body>
            ...
            <div class="title-bar">
                ...
                <div class="title-bar-action">
                    <div class="align-center">
                        <a href="<c:url value="/quan-tri/san-pham/chinh-sua-nhom-huong"/>" class="d-none d-sm-inline-block btn btn-sm btn-primary shadow-sm">Thêm nhóm hương
                        </a>
                    </div>
                    <div class="align-center">
                ...
                <nav style="margin-bottom:15px;">
                    <div class="nav nav-tabs" id="nav-tab" role="tablist">
                        <a class="nav-item nav-link active" id="nav-all-tab" data-toggle="tab" href="#nav-all"
                           role="tab" aria-controls="nav-all" aria-selected="true">Tất cả nhóm hương</a>
                    </div>
                </nav>
                <!--End Nav Button  -->
                    ...
                    <table class="table table-bordered">
                        ...
                        <c:forEach var="item" items="${model.listResult}">
                            <tr>
                                ...
                                <td>
                                    <c:url var="updateIncenseGroup" value="/quan-tri/san-pham/chinh-sua-nhom-huong">
                                        <c:param name="id" value="${item.id}"/>
                                    </c:url>
                                    <a class="btn btn-sm btn-primary btn-edit" data-toggle="tooltip"
                                       title="Cập nhật" href='${updateIncenseGroup}'><i class="fas fa-edit"></i>
                                    </a>
                                </td>
                            </tr>
                        </c:forEach>
    ...
    function warningBeforeDelete() {
        swal({
            ...
            if (isConfirm) {
                ...
                deleteIncenseGroup(ids);
            }
        });

        function deleteIncenseGroup(data) {
            $.ajax({
                url: '${IncenseGroupAPI}',
                type: 'DELETE',
                ...
                success: function (result) {
                    window.location.href = "${listIncenseGroup}?page=1&limit=10&message=delete_success";
                },
